...
\begin{dfn}[Triangle]
Let \(\mathcal{P}\) be an incidence geometry, and let \(x\), \(y\), and \(z\) be distinct points.
...
\begin{proof}
Since \(\mathcal{P}\) is an ordered geometry, it satisfies the Plane Separation property.
