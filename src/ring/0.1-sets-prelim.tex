...
\item If \(A\) is a set, then there is a set \(\POW{A}\), called the \DefTerm{powerset} of \(A\), such that \(x \in \POW{A}\) if and only if \(x \subseteq A\).
...
\item Let \(A\) and \(B\) be sets, with \(B \neq \varnothing\). A subset \(f \subseteq A \times B\) is called a \DefTerm{function} or \emph{mapping} if
\begin{proplist}
...
\begin{proplist}
\item We say \(f\) is \DefTerm{injective} (also known as ``one-to-one'') if whenever \(a_1, a_2 \in A\) such that \(f(a_1) = f(a_2)\), in fact \(a_1 = a_2\).
\item We say \(f\) is \DefTerm{surjective} (also known as ``onto'') if for every \(b \in B\), there exists an \(a \in A\) such that \(f(a) = b\).
\item We say \(f\) is \DefTerm{bijective} if it is both injective and surjective.
\end{proplist}
...
\item Let \(A\) be a set and \(\sigma\) a binary relation on \(A\). We say that \(\sigma\) is a \DefTerm{partial order} on \(A\) if
\begin{proplist}
...
\item Let \(A\) be a set and \(\sigma\) a binary relation on \(A\). We say that \(\sigma\) is an \DefTerm{equivalence} if
\begin{proplist}
\item \(\sigma\) is \emph{reflexive}: \(a \,\sigma\, a\) for all \(a \in A\).
