...
A mapping \(\varphi : R \rightarrow S\) is called a \emph{ring homomorphism}\index{homomorphism} if the following are satisfied.
\begin{proplist}
...
R \arrow[r, "\varphi" description] \arrow[rd, "\varphi"'] & S \arrow[d, "\ID"] & & &   & S \arrow[ld, "\psi"] \\
  & S & & & T &
\end{tikzcd}
\caption{\label{fig:ring-cat-diagram} The punchline of \ref{prop:ring-cat}.}
\end{center}
\end{figure}
