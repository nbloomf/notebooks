...
% Listlike environment for induction proofs
\newlist{inductionproof}{itemize}{2}
\setlist[inductionproof]{align=left,label=(\roman*)}
\newcommand{\basecase}[1]{\item[\textbf{Base Case:}] #1}
\newcommand{\inductivestep}[0]{\item[\textbf{Inductive Step.}]}
